...
@Component({
  selector: 'app-bank-branch-detail-page',
  templateUrl: './bank-branch-detail-page.component.html',
  styleUrls: ['./bank-branch-detail-page.component.scss'],
})
export class BankBranchDetailPageComponent implements OnInit {
  branch?: BankBranch;
  banks: Bank[] = [];
  ...
  editBranch(): void {
    ...
    this.router.navigate(['/config/bank-branches', this.branch.id, 'edit']);
  }
}
