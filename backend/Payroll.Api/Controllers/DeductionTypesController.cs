...
public class DeductionTypesController : ControllerBase
{
    ...
    public DeductionTypesController(IDeductionTypeService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateDeductionTypeRequest request)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateDeductionTypeRequest request)
    {
