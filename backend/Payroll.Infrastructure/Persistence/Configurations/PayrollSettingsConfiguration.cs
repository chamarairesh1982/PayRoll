...
public class PayrollSettingsConfiguration : IEntityTypeConfiguration<PayrollSettings>
{
    public void Configure(EntityTypeBuilder<PayrollSettings> builder)
    {
        ...
        builder.Property(p => p.WeekdayOvertimeMultiplier).IsRequired().HasColumnType("decimal(18,2)");
        builder.Property(p => p.WeekendOvertimeMultiplier).IsRequired().HasColumnType("decimal(18,2)");
        builder.Property(p => p.HolidayOvertimeMultiplier).IsRequired().HasColumnType("decimal(18,2)");
