...
namespace Payroll.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DELETE FROM [AllowanceTypes] WHERE [Id] = '11111111-1111-1111-1111-111111111111'");
            migrationBuilder.Sql("DELETE FROM [AllowanceTypes] WHERE [Id] = '22222222-2222-2222-2222-222222222222'");
            migrationBuilder.Sql("DELETE FROM [AllowanceTypes] WHERE [Id] = '33333333-3333-3333-3333-333333333333'");

            migrationBuilder.Sql("DELETE FROM [DeductionTypes] WHERE [Id] = '44444444-4444-4444-4444-444444444444'");
            migrationBuilder.Sql("DELETE FROM [DeductionTypes] WHERE [Id] = '55555555-5555-5555-5555-555555555555'");
            migrationBuilder.Sql("DELETE FROM [DeductionTypes] WHERE [Id] = '66666666-6666-6666-6666-666666666666'");
            migrationBuilder.Sql("DELETE FROM [DeductionTypes] WHERE [Id] = '77777777-7777-7777-7777-777777777777'");

            migrationBuilder.Sql("DELETE FROM [TaxSlabs] WHERE [Id] = 'aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1'");
            migrationBuilder.Sql("DELETE FROM [TaxSlabs] WHERE [Id] = 'aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2'");
            migrationBuilder.Sql("DELETE FROM [TaxSlabs] WHERE [Id] = 'aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3'");
            migrationBuilder.Sql("DELETE FROM [TaxSlabs] WHERE [Id] = 'aaaaaaa4-aaaa-aaaa-aaaa-aaaaaaaaaaa4'");

            migrationBuilder.Sql("DELETE FROM [EpfEtfRuleSets] WHERE [Id] = '88888888-8888-8888-8888-888888888888'");
            migrationBuilder.Sql("DELETE FROM [TaxRuleSets] WHERE [Id] = '99999999-9999-9999-9999-999999999999'");
