...
namespace Payroll.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251225114859_AddBanksFixed")]
    partial class AddBanksFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payroll.Domain.Payroll.PayRun", b =>
                {
                    ...
                    b.Property<Guid?>("EpfRuleVersionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("EtfRuleVersionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("TaxRuleVersionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EpfRuleVersionId");

                    b.HasIndex("EtfRuleVersionId");
            ...
            modelBuilder.Entity("Payroll.Domain.PayrollConfig.RulePackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "RuleType", "Name")
                        .IsUnique();

                    b.ToTable("RulePackages", (string)null);
                });

            modelBuilder.Entity("Payroll.Domain.PayrollConfig.RulePackageVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RulePackageId", "EffectiveFrom");

                    b.HasIndex("RulePackageId", "VersionNumber")
                        .IsUnique();

                    b.ToTable("RulePackageVersions", null, t =>
                        {
                            t.HasCheckConstraint("CK_RulePackageVersions_EffectiveDates", "([EffectiveTo] IS NULL OR [EffectiveTo] >= [EffectiveFrom])");
                        });
                });
            ...
            modelBuilder.Entity("Payroll.Domain.Payroll.PayRun", b =>
                {
                    ...
                    b.HasOne("Payroll.Domain.PayrollConfig.RulePackageVersion", null)
                        .WithMany()
                        .HasForeignKey("EpfRuleVersionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Payroll.Domain.PayrollConfig.RulePackageVersion", null)
                        .WithMany()
                        .HasForeignKey("EtfRuleVersionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Payroll.Domain.PayrollConfig.RulePackageVersion", b =>
                {
                    b.HasOne("Payroll.Domain.PayrollConfig.RulePackage", "RulePackage")
                        .WithMany("Versions")
                        .HasForeignKey("RulePackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RulePackage");
                });
