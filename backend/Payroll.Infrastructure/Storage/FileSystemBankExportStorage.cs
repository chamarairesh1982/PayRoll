...
public class FileSystemBankExportStorage : IBankExportStorage
{
    private readonly string _basePath;

    public FileSystemBankExportStorage(IOptions<BankExportStorageOptions> options, IHostEnvironment environment)
    {
