...
public class FileSystemStatutoryReportStorage : IStatutoryReportStorage
{
    private readonly string _basePath;

    public FileSystemStatutoryReportStorage(IOptions<ReportStorageOptions> options, IHostEnvironment environment)
    {
