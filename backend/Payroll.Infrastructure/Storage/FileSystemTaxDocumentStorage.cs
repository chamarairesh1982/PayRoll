...
public class FileSystemTaxDocumentStorage : ITaxDocumentStorage
{
    private readonly string _basePath;

    public FileSystemTaxDocumentStorage(IOptions<TaxDocumentStorageOptions> options, IHostEnvironment environment)
    {
